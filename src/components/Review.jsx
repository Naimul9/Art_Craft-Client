...
const Review = () => {
    return (
        <div>
            <h1 className="text-5xl text-center mt-10 bg-zinc-100 py-4">Customers Feedback</h1>
	...
	<div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">This craft item exceeded my expectations! The quality is exceptional, and it adds a unique touch to my space. Highly recommend this artisan's work!</p>
		...
		<div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div className="relative text-center">
                ...
                <p className="px-6 py-1 text-lg italic">This craft item is absolutely stunning! I love the intricate details and craftsmanship. It's a beautiful addition to my collection and received many compliments.</p>
                </Fade>
